...
<body>
							...
							?>
                                        <tr>
                                            ...
                                            <td data-column="status">
                                                <span class="order-status" data-id="<?php echo $row['o_id']; ?>">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 address color-gray">
                        <h5>Address</h5>
                        <p>1086 Tafewa Balewa Road, Lagos</p>
                        <h5>Phone: +234805627457</a></h5>
                    </div>
        ...
        $(".order-status").each(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.trim() !== statusElement.text().trim()) {
    ...
    setInterval(updateOrderStatus, 60000); // Update every 60 seconds
    </script>
